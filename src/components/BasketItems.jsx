    ...
    <div className='basketitems'>
      {shoppingBasketArray.map((e) => (
        <div className="product__info">
          <div className="product__left"><img className="product__image" src={e[2]} /></div>
          <div className="product__right">
            ...
            <div className="basketproductCount">
              <button className='minusButton' onClick={() => { handleMinus(e[0]) }}>-</button>
              <p>{`Qty : ${e[5]}`}</p>
              <button className='plusButton' onClick={() => { handlePlus(e[0]) }}>+</button>
            </div></div>
